//@ts-nocheck
import { Navbar, LoadingLogo, ErrorModal } from "../components/global.js";
import {SpotifyPlaylistGrid, NotionDBGrid, GithubDataGrid} from "../components/data.js";

import LANGUAGE_COLOURS from "../../const/languageColors.json";


const LOAD_DATA_AREA: HTMLElement | null = document.getElementById("load_data");
...
const loadGithubRepositoryData = async (repo_names: string[]) => {
...
const DataPageRender = async () => {
    ...
    renderer.log(localStorage.getItem("recentFetch"));

    console.log(localStorage.getItem("recentFetch"));
